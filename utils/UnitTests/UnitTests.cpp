...
void test_substrings(IUnitTest* _ptest)
{
	...
	string_converter<TCHAR,WCHAR> str1(szStr,2,CP_ACP);

	ok(!lstrcmpW(str1,L"12"),_T("substrings should be copies into buffer"));

	string_converter<CHAR,CHAR> str2(szStr,2,CP_ACP);
